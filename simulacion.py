    ...
    def actualizar_stats(self):
        ...
        for cliente in self.clientes:
            for producto in cliente.comprado:
                ut_super += self.valor_productos[producto]
        self.estadisticas["utilidad_supermercado"] = ut_super
        
        # utilidad espontanea
        ut_espon=0
        for cliente in self.clientes:
            for producto in cliente.compras_espontaneas:
                ut_espon += self.valor_productos[producto]
        self.estadisticas["utilidad_espontanea"] = ut_espon
        
        # probabilidad total
        prob_tot = 0
        for cliente in self.clientes:
            prob_tot += cliente.probabilidad_total
        self.estadisticas["probabilidad_total"] = prob_tot
