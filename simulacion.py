...
class Simulacion:
    def __init__(self, grafo):
        ...
        self.clientes = []
        self.grafo = grafo
        self.estadisticas = {"utilidad_supermercado":0,"utilidad_espontanea":0,"probilidad_total":0,"numero_medio_compras_espontaneas":0,"distancia_media_recorrida":0,"top_productos_espontaneos":[]}
...
if __name__ == "__main__":
    ...
    simulacion.cargar_clientes(4, 40)
    simulacion.calcular_rutas_productos_clientes()
    simulacion.comprar_clientes()
    print(simulacion.clientes)
    simulacion.actualizar_stats()
